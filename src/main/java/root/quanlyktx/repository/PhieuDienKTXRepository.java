...
public interface PhieuDienKTXRepository extends JpaRepository<PhieuDienKTX,Integer> {
    ...
    List<PhieuDienKTX> findByStatusAndMonthRange(@Param("status") Boolean status, @Param("monthStart") Integer monthStart, @Param("monthEnd") Integer monthEnd, @Param("currentYear") Integer currentYear);
}
